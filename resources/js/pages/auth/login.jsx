            ...
            <>
              ...
              <div>
                <div className="mb-1 flex items-center justify-between">
                  ...
                  {/*
                    Tautan "Lupa Password?" sengaja tidak ditampilkan.

                    Selama MAIL_MAILER masih `log`, tautan reset hanya ditulis
                    ke storage/logs dan tidak pernah sampai ke kotak masuk siapa
                    pun — tombol yang diam-diam gagal lebih buruk daripada tidak
                    ada tombol sama sekali.

                    Pemulihan untuk pengguna yang terkunci di luar ditempuh
                    lewat admin: Kelola User -> "Tautan Reset Password"
                    membuatkan tautan sekali pakai memakai token bawaan Laravel,
                    dan admin tidak pernah mengetahui password barunya
                    (temuan V11-03).

                    Untuk mengembalikannya setelah MAIL_MAILER diarahkan ke SMTP
                    sungguhan, cukup hidupkan kembali <Link> di bawah — route
                    password.request dan password.email masih terdaftar.
                  */}
                  {/* <Link

...
export default function EditSeller() {
  const { seller, errors: serverErrors } = usePage().props;
    ...
    <>
      ...
      <div className="mx-auto max-w-3xl px-6 py-8">
        <div className="rounded-2xl bg-white p-8 shadow-md shadow-[#53685B]/20">
          <h2 className="mb-6 text-3xl font-bold text-[#53685B]">✏️ Edit Seller</h2>
...
EditSeller.layout = (page) => (
  <MainLayout title="Edit Seller">{page}</MainLayout>
);
